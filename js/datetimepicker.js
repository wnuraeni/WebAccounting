...
var MonthYearColor="blue";//Font Color of Month and Year in Calendar header.
var WeekHeadColor="#338DC9";//var WeekHeadColor="#18861B";//Background Color in Week header.
...
var TodayColor="#7acdc8";//var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#ee0011";//var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor="#cc0033";//color of font of Year selector.
var MthSelColor="#cc0033";//color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor="#E00038"; //color when mouse move over.
...
//		vCalHeader+="<td align='center'><select name=\"MonthSelector\" onChange=\"javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();\">\n";
		vCalHeader+="<td align='center'><select name=\"MonthSelector\" class=\"input-small\" onChange=\"javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();\">\n";
		for (i=0;i<12;i++) {
			if (i==Cal.Month)
				SelectStr="Selected";
			else
		...
		vCalHeader+="<td align='center'><select name=\"YearSelector\" class=\"input-small\" size=\"1\" onChange=\"javascript:Cal.SwitchYear(this.value);RenderCssCal();\">\n";
...
//		vCalTime+="<td align='center' width='22px'><input type='text' name='hour' maxlength=2 size=1 style=\"WIDTH:22px\" value="+showHour+" onChange=\"javascript:Cal.SetHour(this.value)\">";
		vCalTime+="<td align='center' width='22px'><input type='text' name='hour' maxlength=2 size=1 style=\"WIDTH:12px\" value="+showHour+" onChange=\"javascript:Cal.SetHour(this.value)\">";
...
//			vCalTime+="<input type='text' name='second' maxlength=2 size=1 style=\"WIDTH: 22px\" value="+Cal.Seconds+" onChange=\"javascript:Cal.SetSecond(parseInt(this.value,10))\">";
			vCalTime+="<input type='text' name='second' maxlength=2 size=1 style=\"WIDTH: 12px\" value="+Cal.Seconds+" onChange=\"javascript:Cal.SetSecond(parseInt(this.value,10))\">";
		}
